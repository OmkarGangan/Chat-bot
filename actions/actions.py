...
py = pd.read_csv("E:\\Itvedant_Classroom\\AI\\python.txt", sep="\t")
nlp = pd.read_csv("E:\\Itvedant_Classroom\\AI\\nlp.txt", sep="\t")
dl = pd.read_csv("E:\\Itvedant_Classroom\\AI\\dl.txt", sep="\t")
ds = pd.read_csv("E:\\Itvedant_Classroom\\AI\\ds.txt", sep="\t")
ml = pd.read_csv("E:\\Itvedant_Classroom\\AI\\ml.txt", sep="\t")
stats = pd.read_csv("E:\\Itvedant_Classroom\\AI\\stats.txt", sep="\t")
...
class Actionreturninterview(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,
        ...
        try:
            ...
            driver = webdriver.Chrome('C:\\Users\\Omkar\\Downloads\\chromedriver.exe')
            driver.get(url)
